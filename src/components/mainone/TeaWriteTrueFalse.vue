<template>
    ...
    <div class="inputTable">
        ...
        <el-dialog :visible.sync="dialogVisible" width="65%" :before-close="handleClose">
            ...
            <el-radio v-model="radio1" label="2">停用</el-radio>
            ...
            <div>
                <table class="table1">
                    <tr>
                        ...
                        <td>
                            <div class="input1">
                                <el-input placeholder="题目内容" v-model="input" clearable></el-input>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="flex-start">
                            <el-radio v-model="radio2" label="1">正确</el-radio>
                            <el-radio v-model="radio2" label="2">错误</el-radio>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="flex-start">
                            <el-radio v-model="radio3" label="1">正确</el-radio>
                            <el-radio v-model="radio3" label="2">错误</el-radio>
                        </td>
                    </tr>
